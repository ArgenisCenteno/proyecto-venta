    ...
    <div class="SolvenciaTabla">
        ...
        <div class="border-dark container-fluid border-left round border-right border-top border-bottom  border-1 my-0">
            <div class="my-1 py-1 border-2 primeratabla">
                <h6 class="mb-0 text-center bold text-white">Comprobante de Venta</h6>
            </div>
            <table class="table table-borderless p-0 m-0">
                <tbody>
                    <tr class="">
                        <td class="text-start">
                            ...
                            @endphp
                            <p class="m-0"> <strong>Venta N°: {{$id}}</strong></p>
                        </td>
                        <td class="text-start">
                            <p class="m-0"> <strong>Tipo: {{$venta->pago->tipo}}</strong>
                            </p>
                        </td>
                        <td class="text-end">
                            <p class="m-0"> <strong>Fecha:</strong> {{$fechaVenta}} </p>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div
            ...
            <div class="my-2 py-1 border-2 primeratabla">
                <h6 class="mb-0 text-center bold">Datos del Cliente</h6>
            </div>
